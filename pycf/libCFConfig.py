...
# ../../pycf/generateLibCFConfig.py -b .. -s ../.. -c libCFConfig.py on Tue Jul 10 15:15:53 2012

try: CPPFLAGS = "-I/usr/include -I/home/pletzer/uvcdat/cdat/install/include -I /home/pletzer/uvcdat/cdat/install/Externals/include"
...
NC_UINT64 = 11
NC_STRING = 12
try: NC_MAX_ATOMIC_TYPE = NC_STRING
except: NC_MAX_ATOMIC_TYPE = None
NC_VLEN = 13
NC_OPAQUE = 14
NC_ENUM = 15
NC_COMPOUND = 16
...
NC_FILL_STRING = ""
NC_MAX_BYTE = 127
try: NC_MIN_BYTE = -NC_MAX_BYTE-1
except: NC_MIN_BYTE = None
NC_MAX_CHAR = 255
NC_MAX_SHORT = 32767
try: NC_MIN_SHORT = -NC_MAX_SHORT - 1
except: NC_MIN_SHORT = None
NC_MAX_INT = 2147483647
try: NC_MIN_INT = -NC_MAX_INT - 1
except: NC_MIN_INT = None
NC_MAX_FLOAT = 3.402823466e+38
try: NC_MIN_FLOAT = -NC_MAX_FLOAT
except: NC_MIN_FLOAT = None
NC_MAX_DOUBLE = 1.7976931348623157e+308
try: NC_MIN_DOUBLE = -NC_MAX_DOUBLE
except: NC_MIN_DOUBLE = None
try: NC_MAX_UBYTE = NC_MAX_CHAR
except: NC_MAX_UBYTE = None
NC_MAX_USHORT = 65535
...
try: X_INT64_MIN = -X_INT64_MAX - 1
except: X_INT64_MIN = None
...
try: NC_EURL = NC_EDAPURL
except: NC_EURL = None
try: NC_ECONSTRAINT = NC_EDAPCONSTRAINT
except: NC_ECONSTRAINT = None
NC_INDEPENDENT = 0
NC_COLLECTIVE = 1
